...
const Step4LocationAvailabilityScreen: React.FC = () => {
  ...
  // data was never passed through. Show a real screen with a way forward
  // instead of a blank view — an Alert alone still reads as "the screen
  // froze" once it's dismissed.
  if (!teachingData) {
    return (
