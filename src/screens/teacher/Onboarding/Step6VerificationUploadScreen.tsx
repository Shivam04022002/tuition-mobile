...
const Step6VerificationUploadScreen: React.FC = () => {
  ...
  // instead of via Step 5's "Next", so the accumulated wizard data was never
  // passed through. Show a real screen with a way forward instead of a
  // blank view — an Alert alone still reads as "the screen froze" once it's
  // dismissed.
  if (!pricingData) {
    return (
